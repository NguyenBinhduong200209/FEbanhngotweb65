...
const Menu = () => {
  ...
  return (
    <div className="p-2 md:p-5 ">
      <div className="  m-auto md:flex bg-white rounded min-w-[900px] max-w-[910px]">
        <div className="max-w-sm  overflow-hidden w-full p-5 ">
          <img
            src={productDisplay.image}
            className="hover:scale-105 transition-all h-full rounded min-w-[360px] max-w-[370px] min-h-[350px] max-h-[360px]"
          />
        </div>
        <div className="flex flex-col gap-1 m-4 ">
          ...
          <div className="pt-4">
            <p className="text-slate-600 font-medium">Mô tả sản phẩm : </p>
